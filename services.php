            ...
            <div class="card mb-2 border-0 shadow">
                <div class="row g-0 p-3 alig-item-center">
                    <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                        <img src="images/carousel/car-1.jpg" class="img-fluid rounded" alt="...">
                    </div>
                ...
                <div class="row g-0 p-3 alig-item-center">
                    <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                        <img src="images/carousel/car-2.jpg" class="img-fluid rounded" alt="...">
                    </div>
                        <div class="col-md-5 text-center px-lg-3 px-md-3 px-0">
                ...
                <div class="row g-0 p-3 alig-item-center">
                    <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                        <img src="images/carousel/car-3.jpg" class="img-fluid rounded" alt="...">
                    </div>
                        <div class="col-md-5 text-center px-lg-3 px-md-3 px-0">
